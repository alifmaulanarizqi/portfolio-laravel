...
<div class="content-wrapper mb-5">
    <div class="content">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form action="{{ route('update.skill') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="number" oninput="this.value = Math.round(this.value);" min="0" step="1" max="100" class="form-control" name="proficiency" id="proficiency" value="{{ $skill->proficiency }}">
                        @error('proficiency')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-sm-2 mx-0">
                            <img id="icon_show" style="width:180px; height:200px; object-fit: cover;" class="rounded" alt="200x200" src="{{ (!empty($skill->icon)) ? url($skill->icon) : url('upload/no_image.jpg') }}" data-holder-rendered="true">
                        </div>
                    </div>
                    <div class="d-flex justify-content-start mt-4">
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-primary btn-default">Update Skill</button>
                        </div>
                    </div>
                </form>
            </div>
