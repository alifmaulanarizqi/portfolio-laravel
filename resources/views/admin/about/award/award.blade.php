                ...
                <table id="dtBasicExample2" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row->kategori }}</td>
                            <td>
                                <a href="{{ route('restore.kategori', $row->id) }}"
                                    class="btn btn-info btn-sm">Restore</a>
                                <a class="btn btn-danger btn-sm text-white deleteBtn" data-id="{{ $row->id }}"
                                    data-toggle="modal" data-target="#deleteModal2">Delete</a>
